...
const DRAW_COMBINATIONS: Record<Shape, Shape> = {
...
const MY_SHAPE_LOOKUP: Record<string, Record<Shape, Shape>> = {
  'X': LOSING_COMBINATIONS,
  'Y': DRAW_COMBINATIONS,
  'Z': WINNING_COMBINATIONS
}
...
const part2 = (file: string) => {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    const myShape: Shape = MY_SHAPE_LOOKUP[my][oppShape]
